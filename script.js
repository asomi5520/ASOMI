...
/* =========================================================
   ASOMI 3D HERO CARD ENGINE
   Mouse-follow ONLY inside hero
========================================================= */

document.addEventListener("DOMContentLoaded", () => {

    const hero = document.getElementById("asomiHero3D");

    if (!hero) return;

    const stage = hero.querySelector(".hero-3d-stage");
    const particlesContainer = hero.querySelector(".hero-particles");
    const objects = hero.querySelectorAll(".print-object");
    ...
    for (let i = 0; i < particleCount; i++) {
        ...
        const opacity =
            (Math.random() * 0.65 + 0.15).toFixed(2);

        const duration =
            (Math.random() * 5 + 4).toFixed(2);

        const delay =
            (Math.random() * -8).toFixed(2);

        const dx =
            ((Math.random() - 0.5) * 70).toFixed(1);
    ...
    function animateHero() {
        ...
        /*
         * Each printing object gets a different
         * depth movement.
         */
